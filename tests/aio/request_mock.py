...
class RequestMock(object):
    def __init__(self, mocker):
        ...
        self._real_request = telnyx.aio.api_requestor.APIRequestor.request
        self._stub_request_handler = StubRequestHandler()

        self.constructor_patcher = self._mocker.patch(
            "telnyx.aio.api_requestor.APIRequestor.__init__",
            side_effect=telnyx.aio.api_requestor.APIRequestor.__init__,
            autospec=True,
        )

        self.request_patcher = self._mocker.patch(
            "telnyx.aio.api_requestor.APIRequestor.request",
